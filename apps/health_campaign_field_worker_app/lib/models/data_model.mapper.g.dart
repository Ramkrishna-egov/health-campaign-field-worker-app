...
abstract class BoundaryModelCopyWith<$R> {
  ...
  AuditDetailsCopyWith<$R>? get auditDetails;
  $R call({String? code, String? name, String? label, String? latitude, String? longitude, String? area, String? materializedPath, String? tenantId, bool? isDeleted, int? boundaryNum, int? rowVersion, List<BoundaryModel>? children, AuditDetails? auditDetails});
...
class _BoundaryModelCopyWithImpl<$R> extends BaseCopyWith<BoundaryModel, $R> implements BoundaryModelCopyWith<$R> {
  ...
  @override AuditDetailsCopyWith<$R>? get auditDetails => $value.auditDetails != null ? AuditDetailsCopyWith($value.auditDetails!, (v) => call(auditDetails: v)) : null;
  @override $R call({Object? code = $none, Object? name = $none, Object? label = $none, Object? latitude = $none, Object? longitude = $none, Object? area = $none, Object? materializedPath = $none, Object? tenantId = $none, Object? isDeleted = $none, Object? boundaryNum = $none, Object? rowVersion = $none, List<BoundaryModel>? children, Object? auditDetails = $none}) => $then(BoundaryModel(code: or(code, $value.code), name: or(name, $value.name), label: or(label, $value.label), latitude: or(latitude, $value.latitude), longitude: or(longitude, $value.longitude), area: or(area, $value.area), materializedPath: or(materializedPath, $value.materializedPath), tenantId: or(tenantId, $value.tenantId), isDeleted: or(isDeleted, $value.isDeleted), boundaryNum: or(boundaryNum, $value.boundaryNum), rowVersion: or(rowVersion, $value.rowVersion), children: children ?? $value.children, auditDetails: or(auditDetails, $value.auditDetails)));
}
...
class RolesTypeMapper extends EnumMapper<RolesType> {
  ...
  @override  RolesType decode(dynamic value) {
    switch (value) {
      ...
      case "REGISTRAR": return RolesType.registrar;
      default: throw MapperException.unknownEnumValue(value);
    }
  }
  ...
  @override  dynamic encode(RolesType self) {
    switch (self) {
      ...
      case RolesType.registrar: return "REGISTRAR";
    }
  }
}
